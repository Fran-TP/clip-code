  ...
  return (
    <>
      ...
      <div className="grid flex-1 grid-cols-1 gap-4 md:grid-cols-2">
        <div className="flex flex-col gap-2 rounded-md border-2 border-border-primary bg-bg-card px-4 py-2">
          <h2 className="font-semibold text-xl">Snippet Details</h2>
          <FormSnippet />
        </div>
        <div className="flex flex-col overflow-clip rounded-md border-2 border-border-primary">
          <div className="flex items-center gap-2 p-2">
            <span className="text-sm">Language</span>
            <span className="font-bold text-sm text-text-muted">{formSnippet.language}</span>
          </div>
          <EditorCode />
        </div>
      </div>
